...
export type GetBlogsQuery = { __typename?: 'Query', blogs: Array<{ __typename?: 'Blog', id: number, title: string, url: string, kind: number, createdAt: string, updatedAt: string }> };
...
export type GetBlogQuery = { __typename?: 'Query', blog: { __typename?: 'Blog', id: number, title: string, url: string, kind: number, createdAt: string, updatedAt: string } };
...
export type CreateBlogMutation = { __typename?: 'Mutation', createBlog: { __typename?: 'Blog', id: number, title: string, url: string, kind: number, createdAt: string, updatedAt: string } };
...
export type UpdateBlogMutation = { __typename?: 'Mutation', updateBlog: { __typename?: 'Blog', id: number, title: string, url: string, kind: number, createdAt: string, updatedAt: string } };
