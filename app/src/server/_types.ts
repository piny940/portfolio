...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    fetchAllData(variables?: FetchAllDataQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FetchAllDataQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchAllDataQuery>({ document: FetchAllDataDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'fetchAllData', 'query', variables);
    },
    fetchBlogs(variables?: FetchBlogsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FetchBlogsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchBlogsQuery>({ document: FetchBlogsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'fetchBlogs', 'query', variables);
    },
    fetchProjects(variables?: FetchProjectsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FetchProjectsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchProjectsQuery>({ document: FetchProjectsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'fetchProjects', 'query', variables);
    },
    fetchProject(variables: FetchProjectQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FetchProjectQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchProjectQuery>({ document: FetchProjectDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'fetchProject', 'query', variables);
    },
    fetchTechStacks(variables?: FetchTechStacksQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FetchTechStacksQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchTechStacksQuery>({ document: FetchTechStacksDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'fetchTechStacks', 'query', variables);
    },
    fetchTechnology(variables: FetchTechnologyQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FetchTechnologyQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchTechnologyQuery>({ document: FetchTechnologyDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'fetchTechnology', 'query', variables);
    }
  };
}
